...
```{r posterior_K, fig.width=7, fig.height=4, results='hide'}
...
```{r posterior_beta_inc, fig.width=7, fig.height=8, results='hide'}
...
```{r convergence_check, fig.width=10, fig.height=8, results='hide'}
