...
namespace rjmc_full{
    ...
    struct RJMC_FULL_D
    {
     ...
     //  /       this->posteriorObsTitre = Array::Zero((this->posteriorSamplesLength, this->lengthJumpVec, this->B);
        ...
        void updateClass(List settings, RObject dataList, List RJMCpar)
        {
            this->dataList = dataList;
            ...
            // Counters 
            this->counterFuncEval = RJMCpar["counterFuncEval"];
            this->counterAccepted = RJMCpar["counterAccepted"];
            this->counterPosterior = RJMCpar["counterPosterior"];
            this->counterAdaptive = RJMCpar["counterAdaptive"];
            this->counterNonAdaptive = RJMCpar["counterNonAdaptive"];
            
            this->posteriorSamplesLength = (int)RJMCpar["posteriorSamplesLength"] + (this->iterations-this->burninPosterior)/(this->thin);
       ...
       //     this->posteriorTitreExp = MatrixXd::Zero(this->posteriorSamplesLength, this->lengthJumpVec);
        //    this->posteriorObsTitre = MatrixXd::Zero(this->posteriorSamplesLength, this->lengthJumpVec);
            ...
            MatrixXd posteriorOutPrev = RJMCpar["posteriorOut"];
            for (int i = 0; i < (int)RJMCpar["posteriorSamplesLength"]; i++)
                this->posteriorOut.row(i) = posteriorOutPrev.row(i);

            this->currentLogPosterior = RJMCpar["currentLogPosterior"];
            this->currentSampleMean = RJMCpar["currentSampleMean"];
            this->currentSample = RJMCpar["currentSample"];
            
            this->proposalSample = RJMCpar["proposalSample"];
            this->nonadaptiveScalar = RJMCpar["nonadaptiveScalar"];
            this->adaptiveScalar = RJMCpar["adaptiveScalar"];
            
            this->currentCovarianceMatrix = RJMCpar["currentCovarianceMatrix"];
            this->nonadaptiveCovarianceMat =RJMCpar["nonadaptiveCovarianceMat"];
            this->adaptiveCovarianceMat = RJMCpar["adaptiveCovarianceMat"];
    ...
    void init_sampleInitPrior(rjmc_full::RJMC_FULL_D* model, Rcpp::Function sampleInitPrior) {
    ...
    void init_sampleInitJump(rjmc_full::RJMC_FULL_D* model, Rcpp::Function sampleInitJump) {
    ...
    void init_sampleBirthProposal(rjmc_full::RJMC_FULL_D* model, Rcpp::Function sampleBirthProposal) {
    ...
    void init_sampleDeathProposal(rjmc_full::RJMC_FULL_D* model, Rcpp::Function sampleDeathProposal) {
    ...
    void init_evaluateBirthProposal(rjmc_full::RJMC_FULL_D* model, Rcpp::Function evaluateBirthProposal) {
    ...
    void init_evaluateDeathProposal(rjmc_full::RJMC_FULL_D* model, Rcpp::Function evaluateDeathProposal) {
    ...
    void init_sampleJump(rjmc_full::RJMC_FULL_D* model, Rcpp::Function sampleJump) {
    ...
    void init_sampleProposal(rjmc_full::RJMC_FULL_D* model, Rcpp::Function sampleProposal) {
